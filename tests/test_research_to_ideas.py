...
def test_research_to_angles_generates_multiple_angles():
    ideas = research_to_angles(make_item())
...
def test_research_to_angles_can_select_angles():
    ideas = research_to_angles(make_item(), angles=["how_it_works", "why_it_matters"])
