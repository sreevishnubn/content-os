...
LLM, a research adapter, or a human. This prevents the business logic from
being coupled to one AI provider.
"""
...
def build_idea(
    *,
    ...
    """Create a validated content idea from structured generation output."""
    return ContentIdea(
        title=title.strip(),
        topic=topic.strip(),
